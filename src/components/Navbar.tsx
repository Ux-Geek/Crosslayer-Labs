...
export default function Navbar() {
  return (
    <>
      <header className="fixed top-[24px] left-8 z-50 flex h-[60px] w-auto max-w-[90vw] flex-col items-start gap-[10px] rounded-[99px] border-[0.5px] border-[rgba(160,160,160,0.12)] bg-white p-[10px] shadow-[0_4px_24px_rgba(0,0,0,0.04)] backdrop-blur-xl transition-all">
      ...
      {/* Floating CTA Button (Dark Green) */}
      <div className="fixed top-[24px] right-8 z-50 flex items-center justify-center">
        <a 
          href="#get-started" 
          className="flex h-[60px] items-center justify-center rounded-full bg-[#153C2F] px-8 text-[16px] font-semibold text-white shadow-lg transition-all hover:bg-[#1A4B3A] hover:scale-105 active:scale-95"
        >
          Schedule Demo
        </a>
      </div>
